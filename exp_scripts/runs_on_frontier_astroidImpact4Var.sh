...
# serial
./TestAsteroidImpact4Var --vtkm-device serial $DATADIR/dataForGautam ClosedForm 5000 &> asteroidImpact4Var_cf_serial.log
...
# kokkos
./TestAsteroidImpact4Var --vtkm-device kokkos $DATADIR/dataForGautam ClosedForm 5000 &> asteroidImpact4Var_cf_kokkos.log
...
./TestAsteroidImpact4Var --vtkm-device openmp $DATADIR/dataForGautam ClosedForm 5000 &> asteroidImpact4Var_cf_openmp.log
