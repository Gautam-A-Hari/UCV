...
ln -s $CURRDIR/../install_scripts/frontier_gpu/install/UCV/uncertainty/testing/TestRedSea2Var TestRedSea2Var
...
# serial
./TestRedSea2Var --vtkm-device serial $DATADIR/dataForGautam ClosedForm 5000 &> redsea_cf_serial.log
...
# kokkos
./TestRedSea2Var --vtkm-device kokkos $DATADIR/dataForGautam ClosedForm 5000 &> redsea_cf_kokkos.log
...
./TestRedSea2Var --vtkm-device openmp $DATADIR/dataForGautam ClosedForm 5000 &> redsea_cf_openmp.log
