...
ln -s $CURRDIR/../install_scripts/frontier_gpu/install/UCV/uncertainty/testing/TestRedSea3Var TestRedSea3Var
...
# serial
./TestRedSea3Var --vtkm-device serial $DATADIR/dataForGautam ClosedForm 5000 &> redsea_cf_serial.log
...
# kokkos
./TestRedSea3Var --vtkm-device kokkos $DATADIR/dataForGautam ClosedForm 5000 &> redsea_cf_kokkos.log
...
./TestRedSea3Var --vtkm-device openmp $DATADIR/dataForGautam ClosedForm 5000 &> redsea_cf_openmp.log
